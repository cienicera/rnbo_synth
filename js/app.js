...
let sketch = (p) => {
    p.setup = function() {
        p.createCanvas(600, 600).parent('p5-container'); // Create a canvas of 600x600 pixels and attach to a div
      //  p.background(255); // Set background color to white
        p.stroke(0); // Set border color to black
        p.fill(200); // Set fill color to gray
        p.rect(100, 100, 100, 100); // Draw a rectangle at (100, 100) with width and height of 100
    };
};
...
// Draw the square ID in ascending order by row
